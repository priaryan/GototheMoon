"""v6a: Test spread-conditional taking ONLY (no making skew)."""
...
class TomatoesMM:
    ...
    def generate_orders(self, depth, position):
        ...
        if spread <= 9:
            if microprice > wall_mid:
                buy_margin = 0.0; sell_margin = 1.0
            elif microprice < wall_mid:
                sell_margin = 0.0; buy_margin = 1.0
